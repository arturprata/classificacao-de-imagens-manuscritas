    ...
    for file in os.listdir(diretorio):
        if file.lower().endswith(".bmp"):
            ...
            if label:
                ...
                if img is None:
                    continue
                img = cv2.resize(img, (96, 96))  # Imagem menor = menos atributos
...
pipe = Pipeline([
    ...
    ("pca", PCA(n_components=75)),  # Reduzido de 100 para 50
...
print(classification_report(y_test, y_pred, labels=ordered_labels))
